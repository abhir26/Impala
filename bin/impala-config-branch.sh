...
export CDH_KUDU_JAVA_VERSION=${CDH_KUDU_VERSION}
export IMPALA_KUDU_JAVA_VERSION=${CDH_KUDU_JAVA_VERSION}
[[ -n $IMPALA_KUDU_JAVA_VERSION ]]
export CDH_KUDU_JAVA_URL=${BUILD_REPO_BASE}/kudu-${IMPALA_KUDU_VERSION}.tar.gz
export IMPALA_KUDU_JAVA_URL=${CDH_KUDU_JAVA_URL}
